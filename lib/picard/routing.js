...
var Routes = {
  ...
  get: function(path, handler){ /* optional param: [, routeSet] */
    return Routes.getRoutes.push(Routes.add(path, handler, arguments[2]))
  },
  post: function(path, handler){
    return Routes.postRoutes.push(Routes.add(path, handler, arguments[2]))
  },
  put: function(path, handler){
    return Routes.putRoutes.push(Routes.add(path, handler, arguments[2]))
  },
  del: function(path, handler){
    return Routes.deleteRoutes.push(Routes.add(path, handler, arguments[2]))
  },
