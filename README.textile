h3. Picard: A Micro-framework for node.js
...
p. The sinatra_app_for_benchmarks is a Ruby port of the node sample_app. According to these benchmarks, the node app runs about twice as fast as the Sinatra app on Thin. Below is a sample output of the included benchmark script:
